    ...
    *,
    ...
    if normalized_granularity == "per_channel":
        return [channel_flat[index] for index in range(channel_flat.shape[0])], {
            ...
            "segment_count": int(channel_flat.shape[0]),
...
UniformCodebookUInt8Codec = UniformCodebookCodec
UniformPerChannelCodebookUInt8Codec = UniformPerChannelCodebookCodec
